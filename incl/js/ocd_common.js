function swapstate(id) {
	...
	var bullet = mytab.getElementsByTagName('span')[0];
	var tablebody = mytab.getElementsByTagName('tbody')[0];
	if (bullet.style.backgroundImage == "url(../incl/img/bullet_down.png)") {
		bullet.style.backgroundImage = "url(../incl/img/bullet_right.png)";
		tablebody.style.display = 'none';
	} else {
		bullet.style.backgroundImage = "url(../incl/img/bullet_down.png)";
