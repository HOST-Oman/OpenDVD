...
Object.extend(Element, {
	...
	setTop: function(element,t) {
	   	element = $(element);
    	element.style.top = 1 +"px"; //changed to equal 1 so the pic makes best use of the space available ########
	},
...
newSizeRatio = newHeight / height;
height = newSizeRatio * height;
width = newSizeRatio * width;
...
myLightbox.resizeImageContainer(width, height);
	...
	resizeImageContainer: function( imgWidth, imgHeight) {
		...
		var heightNew = (imgHeight  + (borderSize * 1)); //this now makes it fit on the screen########### orig = 2
